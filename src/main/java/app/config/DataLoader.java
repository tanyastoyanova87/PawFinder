...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        PetRequest dog1 = PetRequest.builder()
                .name("Sharo")
                .specie(Specie.DOG)
        ...
        PetRequest dog2 = PetRequest.builder()
                .name("Iory")
                .specie(Specie.DOG)
        ...
        PetRequest dog3 = PetRequest.builder()
                .name("Rocky")
                .specie(Specie.DOG)
        ...
        PetRequest dog4 = PetRequest.builder()
                .name("Max")
                .specie(Specie.DOG)
                .ageStatus(AgeStatus.ADULT)
                .hairLength(HairLength.MEDIUM)
        ...
        PetRequest dog5 = PetRequest.builder()
                .name("Toby")
                .specie(Specie.DOG)
                .ageStatus(AgeStatus.ADULT)
                .hairLength(HairLength.SHORT)
        ...
        PetRequest dog6 = PetRequest.builder()
                .name("Lucy")
                .specie(Specie.DOG)
                .ageStatus(AgeStatus.BABY)
                .hairLength(HairLength.SHORT)
        ...
        PetRequest dog7 = PetRequest.builder()
                .name("Chanel")
                .specie(Specie.DOG)
                .ageStatus(AgeStatus.YOUNG)
                .hairLength(HairLength.LONG)
        ...
        PetRequest dog8 = PetRequest.builder()
                .name("Zoe")
                .specie(Specie.DOG)
                .ageStatus(AgeStatus.YOUNG)
                .hairLength(HairLength.MEDIUM)
        ...
        PetRequest dog9 = PetRequest.builder()
                .name("Xena")
                .specie(Specie.DOG)
                .ageStatus(AgeStatus.ADULT)
                .hairLength(HairLength.SHORT)
        ...
        PetRequest dog10 = PetRequest.builder()
                .name("Millie")
                .specie(Specie.DOG)
                .ageStatus(AgeStatus.YOUNG)
                .hairLength(HairLength.MEDIUM)
        ...
        PetRequest cat1 = PetRequest.builder()
                .name("Luna")
                .specie(Specie.CAT)
                .ageStatus(AgeStatus.YOUNG)
                .hairLength(HairLength.SHORT)
        ...
        PetRequest cat2 = PetRequest.builder()
                .name("Rosie")
                .specie(Specie.CAT)
                .ageStatus(AgeStatus.ADULT)
                .hairLength(HairLength.SHORT)
        ...
        PetRequest cat3 = PetRequest.builder()
                .name("Daisy")
                .specie(Specie.CAT)
                .ageStatus(AgeStatus.BABY)
                .hairLength(HairLength.SHORT)
        ...
        PetRequest cat4 = PetRequest.builder()
                .name("Tom")
                .specie(Specie.CAT)
                .ageStatus(AgeStatus.ADULT)
                .hairLength(HairLength.SHORT)
        ...
        PetRequest cat5 = PetRequest.builder()
                .name("Poppy")
                .specie(Specie.CAT)
                .ageStatus(AgeStatus.ADULT)
                .hairLength(HairLength.SHORT)
        ...
        PetRequest cat6 = PetRequest.builder()
                .name("Molly")
                .specie(Specie.CAT)
                .ageStatus(AgeStatus.BABY)
                .hairLength(HairLength.SHORT)
        ...
        PetRequest cat7 = PetRequest.builder()
                .name("Milo")
                .specie(Specie.CAT)
                .ageStatus(AgeStatus.ADULT)
                .hairLength(HairLength.SHORT)
        ...
        PetRequest cat8 = PetRequest.builder()
                .name("Charlie")
                .specie(Specie.CAT)
                .ageStatus(AgeStatus.ADULT)
                .hairLength(HairLength.SHORT)
        ...
        PetRequest cat9 = PetRequest.builder()
                .name("Leo")
                .specie(Specie.CAT)
                .ageStatus(AgeStatus.ADULT)
                .hairLength(HairLength.LONG)
        ...
        PetRequest cat10 = PetRequest.builder()
                .name("Lily")
                .specie(Specie.CAT)
                .ageStatus(AgeStatus.BABY)
                .hairLength(HairLength.LONG)
